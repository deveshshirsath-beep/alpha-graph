...
{
  "total": 1491,
  "contractFailures": 239,
  "outcomes": {
    "sample": {
      "unsupported": 102,
      "answered": 76,
      "no_match": 5,
      "clarification_required": 129,
      "no_evidence": 8
    },
    "template-filled": {
      "answered": 314,
...
| 2 | sample | unsupported |  | pass | How many nodes of each Business-layer type exist? |
...
| 5 | sample | answered |  | pass | Which service domains have no parent business domain, or more than one parent? |
| 6 | sample | answered |  | pass | Which business capabilities have no owning team, exactly one owner, or multiple owning teams? |
| 7 | sample | no_match |  | pass | Which teams own no capabilities? |
...
| 42 | sample | no_match |  | pass | Which teams own capabilities implemented by operations-openfinance-app? |
...
| 61 | sample | unsupported |  | pass | Which business areas, domains, capabilities, and capability-owning teams appear in the reverse business-context rollup of operations-openfinance-app? |
...
| 65 | sample | unsupported |  | pass | Which business areas appear in the reverse context rollup of a contract change to Customer Billing API? |
...
| 82 | sample | unsupported |  | pass | How many nodes of each API-layer type exist? |
...
| 98 | sample | no_match |  | pass | Which operations return multiple modeled status codes? |
...
| 159 | sample | unsupported |  | pass | Which business capabilities and capability-owning teams are in the reverse context rollup of Identity and API Security Services API's deprecation? |
...
| 322 | template-filled | unsupported |  | pass | How many nodes of each Business-layer type exist? |
...
| 325 | template-unfilled | error |  | Unresolved placeholder executed as search | Which Business-layer nodes match {name_or_text}? |
...
| 330 | template-filled | answered |  | pass | Which service domains have no parent business domain, or more than one parent? |
...
| 333 | template-filled | no_match |  | pass | Which teams own no capabilities? |
| 334 | template-filled | answered |  | pass | Which capabilities have no implementing application? |
| 335 | template-filled | no_match |  | pass | Which applications implement no business capability? |
...
| 341 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which business domains does {business_area} contain? |
...
| 346 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which service domains does {business_domain} contain? |
...
| 351 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which business capabilities does {service_domain} contain? |
...
| 356 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which business capabilities does {team} own? |
...
| 361 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which business capabilities does {application} implement? |
...
| 366 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which APIs does {application} expose? |
...
| 371 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which business area or areas contain {business_domain}? |
...
| 374 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Does {business_domain} have one parent area, multiple parent areas, or no parent? |
...
| 377 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which business domain contains {service_domain}? |
...
| 381 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which service domain or domains contain {business_capability}? |
...
| 385 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which team or teams own {business_capability}? |
...
| 389 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which applications implement {business_capability}? |
...
| 394 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which application or applications expose {api}? |
...
| 398 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the complete capability, application, API, endpoint, and operation estate under {business_area}? |
...
| 401 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the complete technology estate under {business_domain}, including applications, APIs, deployments, databases, and events? |
...
| 407 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which APIs and operations are associated with {business_capability} through its implementing applications? |
...
| 410 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which APIs and operations are associated with capabilities owned by {team}? |
...
| 437 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations associated with {business_area} are External, Internal, or Partner exposed? |
...
| 440 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations associated with {business_area_or_domain_or_capability_or_team} are classified as PII or PCI? |
...
| 457 | template-filled | no_match |  | pass | Which teams own capabilities implemented by payments-app? |
| 458 | template-filled | no_match |  | pass | Which teams own capabilities implemented by customer-channel-app? |
| 459 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which teams own capabilities implemented by {application}? |
...
| 465 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which business hierarchy and capability-owning teams are associated upstream of {api_version_or_endpoint_or_operation}? |
...
| 468 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which business capabilities are associated with {consumer}'s subscribed APIs or operations through their exposing applications? |
...
| 504 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | How many distinct business areas, domains, capabilities, teams, applications, and APIs converge on {database_or_event}? |
...
| 511 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which domains, service domains, capabilities, teams, applications, APIs, operations, consumers, deployments, databases, and events fall under {business_area}'s change scope? |
...
| 520 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is affected if {business_capability} is renamed, redefined, consolidated, or retired? |
...
| 523 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which implementing applications and their exposed APIs fall into conservative portfolio-review scope if {business_capability} changes? |
...
| 529 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which currently owned capabilities and application-level technology associations enter review scope if {team} gives up ownership of {business_capability}? |
...
| 532 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which capabilities become ownerless if {team} is removed? |
...
| 536 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which shared applications and their associated APIs, databases, or events extend conservative review scope beyond {business_domain}? |
...
| 539 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which externally exposed, PII, or PCI operations fall inside the change radius of {business_area_or_capability_or_team}? |
| 540 | template-filled | unsupported |  | pass | Which business areas, domains, capabilities, and capability-owning teams appear in the reverse business-context rollup of payments-app? |
| 541 | template-filled | unsupported |  | pass | Which business areas, domains, capabilities, and capability-owning teams appear in the reverse business-context rollup of Mortgage Loan API? |
| 542 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which business areas, domains, capabilities, and capability-owning teams appear in the reverse business-context rollup of {application_or_api_or_operation}? |
...
| 551 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | For operations linked by DEPLOYED-TO to {gateway_or_microservice_or_workflow}, which capability-owning teams appear in the reverse business-context rollup? |
| 552 | template-filled | unsupported |  | pass | Which business areas appear in the reverse context rollup of a contract change to Mortgage Loan API? |
| 553 | template-filled | unsupported |  | pass | Which business areas appear in the reverse context rollup of a contract change to Mortgage Loan API? |
| 554 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which business areas appear in the reverse context rollup of a contract change to {api_or_endpoint_or_schema_or_field}? |
...
| 560 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which business capabilities are associated with operations governed by {security_control_or_classification_or_exposure}? |
...
| 563 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which business areas are associated with operations in the reverse data-change radius of {database_or_event}? |
...
| 566 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which business capabilities are associated with operations in the reverse change radius of routing or call changes to {operation}? |
...
| 575 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the overlap between the blast radii of {business_node_set}? |
...
| 578 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What are the union, intersection, and root-specific remainders of the structural scopes of {business_node_set}? |
...
| 585 | template-filled | unsupported |  | pass | How many nodes of each API-layer type exist? |
...
| 588 | template-unfilled | error |  | Unresolved placeholder executed as search | Which APIs, endpoints, operations, schemas, fields, headers, or parameters match {name_or_text}? |
...
| 602 | template-filled | no_match |  | pass | Which endpoints contain more than one operation? |
...
| 607 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What set of APIs is exposed by {application}? |
...
| 611 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which API versions does {api} contain? |
...
| 614 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Does {api} contain more than one version node? |
...
| 617 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which endpoints does {api_version} contain? |
...
| 621 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations does {endpoint} contain? |
...
| 625 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which HTTP method does {operation} support? |
...
| 631 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which security control does {operation} implement? |
| 632 | template-filled | no_match |  | pass | Which operations implement more than one security control? |
...
| 638 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which data-sensitivity classifications apply to {operation}? |
...
| 641 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What exposure classification applies to {operation}? |
...
| 644 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Does {operation} have more than one exposure classification? |
...
| 656 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which request headers does {operation} accept? |
...
| 659 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | How many request headers does {operation} accept? |
...
| 662 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which path parameters does {operation} accept? |
...
| 665 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Do the accepted path-parameter names correspond to placeholders in {operation}'s path property? |
...
| 668 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which query parameters does {operation} accept? |
...
| 671 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | How many query parameters does {operation} accept? |
...
| 674 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which request schema or schemas does {operation} accept? |
| 675 | template-filled | no_match |  | pass | Which operations accept more than one request schema? |
...
| 678 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which status codes can {operation} return? |
| 679 | template-filled | no_match |  | pass | Which operations return multiple modeled status codes? |
...
| 682 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which response schema does {status_code} return? |
...
| 686 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which response headers does {status_code} return? |
...
| 692 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which top-level fields does {schema} contain? |
...
| 698 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which nested fields does {field} contain? |
...
| 701 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the complete nested field tree beneath {field}? |
...
| 704 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which APIs does {consumer} subscribe to? |
...
| 708 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations does {consumer} subscribe to? |
...
| 712 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which applications expose {api}? |
...
| 715 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Is {api} shared by multiple applications? |
| 716 | template-filled | answered |  | pass | Which API contains v1? |
| 717 | template-filled | answered |  | pass | Which API contains v5? |
| 718 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which API contains {api_version}? |
...
| 721 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Does {api_version} have a unique parent API? |
...
| 724 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which API version contains {endpoint}? |
...
| 727 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Does {endpoint} have a unique parent version? |
...
| 730 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which endpoint contains {operation}? |
...
| 733 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Is {operation} contained by more than one endpoint? |
...
| 736 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which operations support {http_method}? |
...
| 739 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which APIs and applications expose operations supporting {http_method}? |
...
| 742 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations implement {security_control}? |
...
| 751 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which APIs, applications, consumers, and business capabilities are in scope for {classification}? |
...
| 754 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which operations have {exposure} exposure? |
...
| 760 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which operations are deployed to {deployment_target}? |
...
| 763 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which APIs, applications, consumers, and capabilities are associated with operations linked to {deployment_target} by DEPLOYED-TO? |
...
| 766 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations accept {header} as a request header? |
...
| 769 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | In which APIs and versions is {header} accepted? |
...
| 772 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which status-code responses return {header}? |
...
| 775 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which operations, endpoints, and APIs can return {header}? |
...
| 778 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations accept {path_parameter}? |
...
| 781 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Across which paths, versions, and APIs is {path_parameter} used? |
...
| 784 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations accept {query_parameter}? |
...
| 787 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Across which consumers and APIs is {query_parameter} used? |
...
| 790 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations accept {schema} as a request schema? |
...
| 796 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations return {status_code}? |
...
| 799 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which APIs and versions expose {status_code}? |
...
| 802 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which status codes and operations return {schema} as a response? |
...
| 808 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which schema or parent field contains {field}? |
...
| 811 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What are all ancestor fields and the root schema of {field}? |
...
| 814 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which request or response operations expose {field}? |
...
| 817 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which consumers subscribe to {api_or_operation}? |
...
| 820 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | How many distinct consumers depend directly on {api_or_operation}? |
...
| 823 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the complete API tree exposed by {application}, from API through version, endpoint, and operation? |
...
| 826 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the complete contract of {api}, including every operation's request and response elements? |
...
| 835 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For {endpoint}, what are the method, operationId, path, service, service category, security, exposure, sensitivity, and deployment target of every operation? |
...
| 838 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What request headers, path parameters, query parameters, request schemas, and nested fields does {operation} accept? |
...
| 841 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What status codes, response headers, response schemas, and nested fields can {operation} return? |
...
| 844 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the maximum request or response field nesting depth for {operation_or_api}? |
...
| 847 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which required fields occur at each canonical path in {schema}? |
...
| 850 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which fields in {schema} allow additional properties? |
...
| 861 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What APIs and operations form {consumer}'s complete subscription footprint? |
...
| 867 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | Which subscribed operations of {consumer} are External, Internal, or Partner exposed? |
...
| 873 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which security controls are implemented by the operations used by {consumer}? |
...
| 876 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which GATEWAY, MICROSERVICE, or WORKFLOW category nodes are linked by DEPLOYED-TO from {consumer}'s subscribed operations? |
...
| 879 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which databases and events are reached transitively from {consumer}'s subscriptions? |
...
| 882 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which operations used by {consumer} call or route to other operations? |
...
| 896 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {field}, which parent field tree, schema, request or response, status code, operation, endpoint, version, API, and application expose it? |
...
| 902 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which consumers ultimately depend on {field_or_schema_or_header_or_parameter_or_status_code}? |
...
| 911 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {path_parameter_or_query_parameter}, which operations, paths, versions, and APIs use it? |
...
| 917 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {security_control_or_exposure_or_classification}, which operations, endpoints, APIs, applications, consumers, capabilities, and teams are in scope? |
...
| 926 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {event}, which producing operations and subscribed consumers sit upstream? |
...
| 929 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {operation}, which callers, routers, endpoints, APIs, consumers, applications, capabilities, and teams depend on it? |
...
| 934 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the shortest evidence path between {consumer_or_api} and {field_or_database_or_event}? |
...
| 941 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | Which PII or PCI operations are consumed by {consumer}? |
...
| 944 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | Which PII or PCI operations are deployed to {deployment_target}? |
...
| 947 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which PII or PCI operations read from, connect to, write to, or update {database}? |
...
| 950 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which PII or PCI operations produce {event}? |
...
| 954 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which operations satisfying {http_method}, {exposure}, {classification}, {security_control}, and {deployment_target} all at once exist? |
...
| 965 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is affected if {application} stops exposing its APIs? |
...
| 971 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which versions, endpoints, operations, consumers, contracts, deployments, databases, events, applications, capabilities, teams, and business areas are in {api}'s deprecation radius? |
...
| 974 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is affected if {api_version} is retired? |
...
| 977 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which consumers depend directly on {api_version}'s operations even if they subscribe to the parent API separately? |
...
| 980 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is affected if {endpoint} is removed or moved? |
...
| 983 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is affected if {operation}'s path, method, operationId, service, or serviceCategory changes? |
...
| 986 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which called or routed operations expand the transitive blast radius of deprecating {operation}? |
| 987 | template-filled | unsupported |  | pass | Which business capabilities and capability-owning teams are in the reverse context rollup of Mortgage Loan API's deprecation? |
| 988 | template-filled | unsupported |  | pass | Which business capabilities and capability-owning teams are in the reverse context rollup of Mortgage Loan API's deprecation? |
| 989 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which business capabilities and capability-owning teams are in the reverse context rollup of {api_or_version_or_endpoint_or_operation}'s deprecation? |
...
| 992 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the contract-change blast radius of changing or removing request {header}? |
...
| 995 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the contract-change blast radius of renaming, adding, or removing {path_parameter}? |
...
| 998 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the contract-change blast radius of changing {query_parameter}? |
...
| 1001 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the contract-change blast radius of {schema}? |
...
| 1004 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which operations and consumers are affected if {field} changes type or format? |
...
| 1007 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which operations and consumers are affected if {field} changes required status? |
...
| 1015 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is affected if {status_code} is added, removed, or changes meaning? |
...
| 1018 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is affected if response {header} changes or is removed? |
...
| 1021 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the response-contract blast radius of {schema}? |
...
| 1024 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which consumers and callers are affected if {field} changes in a response schema? |
...
| 1028 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the combined request-and-response blast radius when {schema_or_field} appears in both directions? |
...
| 1031 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which APIs and consumers are affected by changing all occurrences of {canonical_path}? |
...
| 1034 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | What is the security-change blast radius of {security_control}? |
...
| 1038 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the policy-change blast radius of reclassifying {operation} as PII or PCI? |
...
| 1043 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which consumers, associated business capabilities, and capability-owning teams enter review scope if {operation}'s exposure changes from Internal or Partner to External? |
...
| 1048 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | For operations linked by DEPLOYED-TO to {gateway_or_microservice_or_workflow}, which endpoints, APIs, consumers, applications, capabilities, and capability-owning teams are in structural scope? |
...
| 1051 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | What is affected if {operation} moves between gateway and microservice deployment categories? |
...
| 1054 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which consumers are affected by a service or serviceCategory change to {operation}? |
...
| 1057 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which API contracts are in the reverse outage radius of {database}? |
...
| 1060 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which APIs and consumers are in the reverse outage radius of {event}? |
...
| 1063 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which APIs and consumers are affected by a data change to {database_or_event}? |
...
| 1066 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which APIs and consumers are affected if a called or routed-to {operation} changes or fails? |
...
| 1070 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the union and intersection of the blast radii of {api_node_set}? |
...
| 1104 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations does {operation} call directly? |
...
| 1107 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | What method and path were recorded for each call from {operation}? |
...
| 1111 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations does {operation} route to directly? |
...
| 1114 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | What path and HTTP method were recorded for each route from {operation}? |
...
| 1117 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Does {operation} route to itself, to a gateway operation, or to a microservice operation? |
...
| 1120 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which databases does {operation} connect to? |
...
| 1124 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which databases and tables does {operation} read from? |
...
| 1127 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which captured queries support the read dependencies of {operation}? |
...
| 1130 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which databases and tables does {operation} write to? |
...
| 1133 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which captured queries support the write dependencies of {operation}? |
...
| 1136 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which databases and tables does {operation} update? |
...
| 1139 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which captured queries support the update dependencies of {operation}? |
...
| 1142 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which events does {operation} produce? |
...
| 1145 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What destinationName and observed telemetry are recorded for each event produced by {operation}? |
...
| 1148 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which events does {event} consume? |
...
| 1152 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which events does {event} produce? |
...
| 1155 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What event-to-event production chain starts at {event}? |
...
| 1158 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations does {event} call? |
...
| 1162 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which databases does {event} connect to? |
...
| 1166 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which databases and tables does {event} read from? |
...
| 1170 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which databases and tables does {event} write to? |
...
| 1174 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which databases and tables does {event} update? |
...
| 1182 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which database, including itself, does {database} connect to? |
...
| 1186 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations call {operation} directly? |
...
| 1189 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | Which caller has the highest callCount or errorCount toward {operation}? |
...
| 1192 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations route to {operation} directly? |
...
| 1195 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | Which gateway paths and methods feed {operation}? |
...
| 1198 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations connect to {database}? |
...
| 1202 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations read from {database}? |
...
| 1208 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations write to {database}? |
...
| 1214 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations update {database}? |
...
| 1220 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which operations produce {event}? |
...
| 1224 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which events consume {event}? |
...
| 1227 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Does {event} participate in a self-consuming or cross-event loop? |
...
| 1230 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which event produces {event}? |
...
| 1233 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What event chain leads into {event}? |
...
| 1236 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which events call {operation}? |
...
| 1240 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which events connect to {database}? |
...
| 1244 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which events read from {database}? |
...
| 1247 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which event reads use {table_name_or_query}? |
...
| 1250 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which events write to {database}? |
...
| 1253 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which event writes use {table_name_or_query}? |
...
| 1256 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which events update {database}? |
...
| 1259 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which event updates use {table_name_or_query}? |
...
| 1262 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which database calls {operation} through the observed extension edge? |
...
| 1266 | template-unfilled | no_match |  | Unfilled template must request parameters + actual - expected  + 'no_match' - 'clarification_required'  | Which database connects to {database}? |
...
| 1269 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Is {database} the source and target of the same connection edge? |
...
| 1275 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {business_domain_or_service_domain}, which services, operations, databases, and events are reachable? |
...
| 1278 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For {business_capability}, which applications, APIs, endpoints, runtime services, and operations form its conservative implementation scope? |
...
| 1281 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For {team}, what runtime estate is reachable through the capabilities it owns? |
...
| 1284 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | For {application}, which exposed APIs terminate in which gateway or microservice operations? |
...
| 1287 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For {api}, which endpoints have multiple runtime implementations? |
...
| 1290 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For {api_version}, which services, databases, tables, and events are downstream? |
...
| 1293 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | For {endpoint}, what gateway-to-gateway or gateway-to-microservice route chain handles it? |
...
| 1296 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For {endpoint}, what call chain, database access, and event production can follow execution? |
...
| 1299 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For {consumer}, which directly subscribed operations and transitive runtime dependencies are reachable? |
...
| 1302 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For an API-level subscription held by {consumer}, which contained operations and dependencies enter scope? |
...
| 1307 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For operations protected by {security_control}, which downstream services and data stores are reachable? |
...
| 1310 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | For operations accepting {contract_element}, which runtime dependencies execute behind them? |
...
| 1316 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Across versions of {api_name}, how do service assignments, routes, calls, database dependencies, and event outputs differ? |
...
| 1324 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {operation}, which endpoint, version, API, application, capability, business hierarchy, and team are upstream? |
...
| 1327 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {service}, which operations, APIs, applications, capabilities, areas, and teams map back to it? |
...
| 1330 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {database}, which operations and events connect, read, write, or update it, separated by access mode? |
...
| 1333 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {database}, which callers and routes lead back to API entry points and consumers? |
...
| 1336 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {database}, which applications, capabilities, business areas, and teams depend on it? |
...
| 1339 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {table_name}, which queries, operations, services, APIs, consumers, capabilities, and teams touch it? |
...
| 1342 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {query}, which edge, operation or event, database, and upstream context produced it? |
...
| 1345 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {event}, which operations or events produced it? |
...
| 1348 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {event}, which APIs, consumers, applications, capabilities, and teams sit upstream of its producers? |
...
| 1351 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from an operation called by {event}, which downstream database and event effects follow? |
...
| 1354 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from callee {operation}, which operations, events, or databases call it directly or transitively? |
...
| 1357 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from routed target {operation}, which gateway or intermediate operations feed it? |
...
| 1363 | template-unfilled | answered |  | Unfilled template must request parameters + actual - expected  + 'answered' - 'clarification_required'  | Starting from {database_or_event}, which External, Partner, PII, or PCI operation surfaces can reach it? |
...
| 1366 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Starting from {database_or_event}, which request and response contract elements are attached to its upstream operations? |
...
| 1396 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | If {operation} is used as an outage root, which direct callers, routed callers, event-call paths, consumers, APIs, applications, capabilities, domains, areas, and teams are structurally in scope? |
...
| 1414 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | If {service} is migrated, which routes, calls, data access, event production, API contracts, and business-owner rollups fall within migration or retest scope? |
...
| 1433 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which business areas share {database}, causing an outage radius to cross organizational boundaries? |
...
| 1444 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | If {event}'s contract changes, which producers, consuming events, called operations, and upstream consumers require review? |
...
| 1448 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | If an operation called by {event} is used as an outage root, which event-call edge and downstream database writes or produced events fall within structural scope? |
...
| 1452 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | Which business areas and teams share {event} through different producer operations? |
...
| 1457 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | If {api_version} is retired, which runtime operations, services, routes, callees, databases, events, and consumers are affected? |
...
| 1463 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | If response {schema_or_field_or_header_or_status_code} changes, which operations, APIs, and subscribed consumers are affected? |
...
| 1466 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | If {security_control} changes, which operations, consumers, APIs, capabilities, and downstream dependencies are in scope? |
...
| 1470 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | If {consumer} is removed or compromised, which subscribed operations and API-derived Runtime paths are in scope? |
...
| 1485 | template-unfilled | unsupported |  | Unfilled template must request parameters + actual - expected  + 'unsupported' - 'clarification_required'  | What is the union, intersection, and root-specific remainder of the blast radii for {runtime_node_set}? |
