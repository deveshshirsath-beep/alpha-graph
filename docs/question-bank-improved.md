...
```json
{
  "total": 1491,
  "contractFailures": 0,
  "completedAt": "2026-09-21T11:51:57.197Z",
  ...
  "clarificationReasons": {
    "entity_ambiguity": 62,
    "unconsumed_constraints": 228,
    "scope_not_resolved": 20,
    "selection_constraints_unclear": 7,
    "field_root_required": 2,
    "two_roots_required": 2,
    "route_target_required": 2
  },
  "plannerCoverageFailures": 531,
...
| 9 | sample | answered |  | pass | What percentage of each business hierarchy level is linked to its expected parent and child types? |
...
| 14 | sample | no_evidence |  | pass | Which business domains share or overlap in service-domain membership? |
...
| 19 | sample | answered |  | pass | Which applications span multiple service domains, business domains, or business areas through the capabilities they implement? |
...
| 24 | sample | no_evidence |  | pass | Which service domains are referenced by multiple business domains? |
| 25 | sample | answered |  | pass | Which capabilities cross service-domain boundaries? |
...
| 32 | sample | clarification_required | answered | pass | Which applications implement capabilities in Account Reconciliation, and which APIs, versions, endpoints, and operations are associated through those applications? |
...
| 35 | sample | answered |  | pass | Which events are produced by operations associated with Administer collateral assets through its implementing applications? |
| 36 | sample | answered |  | pass | Which request headers, parameters, schemas, and fields occur in APIs associated with Administer counterparties? |
...
| 38 | sample | clarification_required | answered | pass | Which security controls are implemented by operations associated with Account Reconciliation? |
...
| 41 | sample | answered |  | pass | Which business capabilities are implemented by cards-merchant-app, and which service domains, business domains, and business areas contain them? |
...
| 44 | sample | clarification_required | clarification_required | pass | Which business capabilities and capability-owning teams are associated with operations linked to GATEWAY by DEPLOYED-TO? |
...
| 46 | sample | answered |  | pass | Which business areas are associated with operations that read from banking_demo-postgres? |
...
| 55 | sample | answered |  | pass | What is affected if Administer collateral assets is renamed, redefined, consolidated, or retired? |
...
| 63 | sample | clarification_required | clarification_required | pass | Which business capabilities and capability-owning teams are associated with operations in the reverse outage radius of sms-events-unknown? |
...
| 66 | sample | answered |  | pass | Which capabilities and capability-owning teams appear in the context rollup if the v5 Current Account API version is deprecated? |
| 67 | sample | answered |  | pass | Which business capabilities are associated with operations governed by OAuth 2? |
| 68 | sample | clarification_required | no_match | pass | Which business areas are associated with operations in the reverse data-change radius of redis-redis? |
...
| 76 | sample | answered |  | pass | What is the overlap between the blast radii of Accounts and Deposits and Payments and Cards? |
| 77 | sample | clarification_required | answered | pass | What are the union, intersection, and root-specific remainders of the structural scopes of Cards and Payments? |
...
| 88 | sample | no_evidence |  | pass | Which consumers have no API or operation subscriptions? |
...
| 98 | sample | answered |  | pass | Which operations return multiple modeled status codes? |
...
| 121 | sample | answered |  | pass | What APIs and operations form Bank Sync's complete subscription footprint? |
...
| 136 | sample | answered |  | pass | Starting from OAuth 2, which operations, endpoints, APIs, applications, consumers, capabilities, and teams are in scope? |
...
| 141 | sample | answered |  | pass | Which External operations are classified as PII? |
| 142 | sample | answered |  | pass | Which External operations are classified as PCI? |
| 143 | sample | answered |  | pass | Which Partner operations are classified as PII or PCI? |
| 144 | sample | answered |  | pass | Which PII or PCI operations are deployed to GATEWAY? |
| 145 | sample | answered |  | pass | Which PII or PCI operations produce banking.api.events-unknown? |
| 146 | sample | answered |  | pass | Which operations satisfying DELETE, Internal, PII, OAuth 2, and MICROSERVICE all at once exist? |
| 147 | sample | answered |  | pass | Which operations lack one or more of method, OAuth 2, exposure, and deployment relationships? |
| 148 | sample | no_evidence |  | pass | Which PII or PCI operations have no subscribing consumer? |
...
| 162 | sample | clarification_required | answered | pass | What is the contract-change blast radius of renaming, adding, or removing customerId? |
| 163 | sample | clarification_required | answered | pass | What is the contract-change blast radius of changing limit? |
...
| 165 | sample | clarification_required | answered | pass | Which operations and consumers are affected if the customerId field changes type or format? |
...
| 181 | sample | answered |  | pass | What is the security-change blast radius of OAuth 2? |
...
| 186 | sample | clarification_required | answered | pass | Which consumers, associated business capabilities, and capability-owning teams enter review scope if Create Banking Account Bill Payment's exposure changes from Internal or Partner to External? |
...
| 190 | sample | answered |  | pass | Which consumers, associated business capabilities, and capability-owning teams enter review scope if Create Aggregation Customer Account's exposure changes from Internal or Partner to External? |
...
| 201 | sample | clarification_required | clarification_required | pass | What is the union and intersection of the blast radii of Customer Billing API and Direct Debit API? |
...
| 209 | sample | clarification_required | clarification_required | pass | What is the union and intersection of the blast radii of Identity and API Security Services API and Card Case API? |
...
| 213 | sample | answered |  | pass | Which operations have missing or blank httpMethod, path, service, serviceCategory, or operationId properties? |
...
| 253 | sample | answered |  | pass | Starting from hierarchy_v6-postgres, which applications, capabilities, business areas, and teams depend on it? |
...
| 302 | sample | clarification_required | no_evidence | pass | If request x-mock-response changes, which operations and downstream Runtime paths may be affected? |
...
| 336 | template-filled | answered |  | pass | What percentage of each business hierarchy level is linked to its expected parent and child types? |
...
| 348 | template-filled | no_evidence |  | pass | Which business domains share or overlap in service-domain membership? |
...
| 363 | template-filled | answered |  | pass | Which applications span multiple service domains, business domains, or business areas through the capabilities they implement? |
...
| 378 | template-filled | no_evidence |  | pass | Which service domains are referenced by multiple business domains? |
...
| 382 | template-filled | answered |  | pass | Which capabilities cross service-domain boundaries? |
...
| 402 | template-filled | answered |  | pass | Which applications implement capabilities in Open Banking Access Services, and which APIs, versions, endpoints, and operations are associated through those applications? |
| 403 | template-filled | answered |  | pass | Which applications implement capabilities in Digital and Assisted Channel Services, and which APIs, versions, endpoints, and operations are associated through those applications? |
...
| 420 | template-filled | answered |  | pass | Which events are produced by operations associated with Manage customer billing through its implementing applications? |
| 421 | template-filled | answered |  | pass | Which events are produced by operations associated with Manage card service cases through its implementing applications? |
...
| 429 | template-filled | answered |  | pass | Which request headers, parameters, schemas, and fields occur in APIs associated with Manage customer billing? |
| 430 | template-filled | answered |  | pass | Which request headers, parameters, schemas, and fields occur in APIs associated with Manage card service cases? |
...
| 441 | template-filled | answered |  | pass | Which security controls are implemented by operations associated with Manage customer billing? |
| 442 | template-filled | answered |  | pass | Which security controls are implemented by operations associated with Manage card service cases? |
...
| 454 | template-filled | answered |  | pass | Which business capabilities are implemented by payments-app, and which service domains, business domains, and business areas contain them? |
| 455 | template-filled | answered |  | pass | Which business capabilities are implemented by customer-channel-app, and which service domains, business domains, and business areas contain them? |
...
| 460 | template-filled | answered |  | pass | Which capabilities and capability-owning teams are associated with Mortgage Loan API through its exposing applications? |
| 461 | template-filled | answered |  | pass | Which capabilities and capability-owning teams are associated with Mortgage Loan API through its exposing applications? |
...
| 481 | template-filled | answered |  | pass | Which business areas are associated with operations that read from banking_demo-postgres? |
| 482 | template-filled | answered |  | pass | Which business areas are associated with operations that read from redis-redis? |
...
| 518 | template-filled | answered |  | pass | What is affected if Manage customer billing is renamed, redefined, consolidated, or retired? |
| 519 | template-filled | answered |  | pass | What is affected if Manage card service cases is renamed, redefined, consolidated, or retired? |
...
| 537 | template-filled | clarification_required |  | pass | Which externally exposed, PII, or PCI operations fall inside the change radius of Accounts and Deposits? |
| 538 | template-filled | clarification_required |  | pass | Which externally exposed, PII, or PCI operations fall inside the change radius of Customer Platforms Team? |
...
| 558 | template-filled | answered |  | pass | Which business capabilities are associated with operations governed by OAuth 2? |
...
| 599 | template-filled | no_evidence |  | pass | Which consumers have no API or operation subscriptions? |
| 600 | template-filled | answered |  | pass | Which APIs or operations have no subscribing consumers? |
...
| 679 | template-filled | answered |  | pass | Which operations return multiple modeled status codes? |
...
| 860 | template-filled | answered |  | pass | What APIs and operations form Loan Bridge's complete subscription footprint? |
...
| 915 | template-filled | answered |  | pass | Starting from OAuth 2, which operations, endpoints, APIs, applications, consumers, capabilities, and teams are in scope? |
...
| 935 | template-filled | answered |  | pass | Which External operations are classified as PII? |
| 936 | template-filled | answered |  | pass | Which External operations are classified as PCI? |
| 937 | template-filled | answered |  | pass | Which operations are classified as both PII and PCI? |
| 938 | template-filled | answered |  | pass | Which Partner operations are classified as PII or PCI? |
...
| 948 | template-filled | answered |  | pass | Which PII or PCI operations produce banking.api.events-unknown? |
| 949 | template-filled | answered |  | pass | Which PII or PCI operations produce banking.workflow.commands-unknown? |
...
| 955 | template-filled | answered |  | pass | Which operations lack one or more of method, OAuth 2, exposure, and deployment relationships? |
| 956 | template-filled | answered |  | pass | Which External operations have no modeled PII or PCI classification? |
| 957 | template-filled | no_evidence |  | pass | Which PII or PCI operations have no subscribing consumer? |
| 958 | template-filled | clarification_required |  | pass | Which APIs have the highest number of External PII or PCI operations? |
...
| 993 | template-filled | answered |  | pass | What is the contract-change blast radius of renaming, adding, or removing accountId? |
| 994 | template-filled | answered |  | pass | What is the contract-change blast radius of renaming, adding, or removing accountId? |
...
| 996 | template-filled | answered |  | pass | What is the contract-change blast radius of changing limit? |
| 997 | template-filled | answered |  | pass | What is the contract-change blast radius of changing offset? |
...
| 1016 | template-filled | answered |  | pass | What is affected if response x-mock-response changes or is removed? |
| 1017 | template-filled | answered |  | pass | What is affected if response x-mock-response changes or is removed? |
...
| 1032 | template-filled | answered |  | pass | What is the security-change blast radius of OAuth 2? |
| 1033 | template-filled | answered |  | pass | What is the security-change blast radius of OAuth 2? |
...
| 1041 | template-filled | answered |  | pass | Which consumers, associated business capabilities, and capability-owning teams enter review scope if List Banking Cross Channel Party Authentication Operations Tion Create Party Authentications's exposure changes from Internal or Partner to External? |
| 1042 | template-filled | answered |  | pass | Which consumers, associated business capabilities, and capability-owning teams enter review scope if Get Banking Treasury Balance Sheet Management By Balance Sheet Management Id's exposure changes from Internal or Partner to External? |
...
| 1086 | template-filled | answered |  | pass | Which operations have missing or blank httpMethod, path, service, serviceCategory, or operationId properties? |
...
| 1334 | template-filled | answered |  | pass | Starting from banking_demo-postgres, which applications, capabilities, business areas, and teams depend on it? |
| 1335 | template-filled | answered |  | pass | Starting from redis-redis, which applications, capabilities, business areas, and teams depend on it? |
...
| 1361 | template-filled | clarification_required |  | pass | Starting from banking_demo-postgres, which External, Partner, PII, or PCI operation surfaces can reach it? |
| 1362 | template-filled | clarification_required |  | pass | Starting from redis-redis, which External, Partner, PII, or PCI operation surfaces can reach it? |
...
| 1387 | template-filled | clarification_required |  | pass | Which External, PII, or PCI operations have an error-bearing Runtime path? |
